...
function enquire_js() {
	// Functions js
	wp_enqueue_script( 'scripts', get_template_directory_uri() . '/build/scripts.min.js', null, '1.0.0', true );
...
//	wp_enqueue_style( 'custom-login', get_template_directory_uri() . '/build/style-login.css' );
//}
